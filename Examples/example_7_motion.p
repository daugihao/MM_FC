/* 
  ...
  This example shows a bit advanced working with raw accelerometer data.
  Detects motion and colors of the whole cube depending on motion direction. Mildly amusing.
*/
